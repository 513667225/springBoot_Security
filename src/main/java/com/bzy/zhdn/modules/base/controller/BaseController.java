package com.bzy.zhdn.modules.base.controller;


import java.util.Enumeration;
import javax.servlet.http.HttpServletRequest;
import cn.hutool.log.Log;
import com.bzy.zhdn.common.exception.CUDException;
import com.bzy.zhdn.common.utils.LogUtils;
import com.bzy.zhdn.common.utils.P;
    ...
    public P getParamsMap(HttpServletRequest request) throws Exception {
        ...
        while(names.hasMoreElements()) {
            ...
            if(paramValue == null){
                ...
                parameter.put(paramName, paramValue[0]);
            }else{
